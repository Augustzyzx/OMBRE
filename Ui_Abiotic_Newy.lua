...
function BlurFrame(getFrame)
	...
	do
		...
		local ahahahahha = IsNotNaN(camera:ScreenPointToRay(0,0).Origin.x)
		while not ahahahahha do
			RunService.RenderStepped:wait()
			ahahahahha = IsNotNaN(camera:ScreenPointToRay(0,0).Origin.x)
		end
	end
...
function library.Create(options)
	...
	TextLabel_6.Text = "Abiotic Hub | Community"
...
local Windown = library.Create({
	Title = "Abiotic Hub | Blade Ball", Logo = 17788183385,
...
Page1.CreateToggle({
	Name = "Auto Parry",
	Dis = " Automatic Detect The Balls",
	Value = true,
	Callback = function(v)
		print("wow")
	end,
...
Page1.CreateButton({
	Name = "Version",
	Callback = function()
		local version = loadstring(game:HttpGet('https://raw.githubusercontent.com/Augustzyzx/OMBRE/main/version.lua'))()
