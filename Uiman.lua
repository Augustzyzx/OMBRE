...
ToggleButton.Text = "<U>"
ToggleButton.TextColor3 = Color3.fromRGB(255,0,137)
...
function library:loader(props)
	...
	local scripttitle = utility.new(
		"TextLabel",
		{
			...
			TextColor3 = Color3.fromRGB(255,0,137),
			TextXAlignment = "Center",
			TextSize = 12,
			TextStrokeTransparency = 0,
			ZIndex = 9903,
	...
	local makebutton = function(name,parent)
		...
		utility.new(
			"UIGradient",
			{
				Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(199, 191, 204)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255,0,137))},
				Rotation = 90,
				Parent = button_color
			}
		)
...
function sections:colorpicker(props)
	...
	local outline4 = utility.new(
		"Frame",
		{
			BackgroundColor3 = Color3.fromRGB(255,0,137),
			BorderColor3 = Color3.fromRGB(56, 56, 56),
			BorderMode = "Inset",
			BorderSizePixel = 1,
			Size = UDim2.new(1,0,1,0),
	...
	local huecursor_inline = utility.new(
		...
		{
			BackgroundColor3 = Color3.fromHSV(h,1,1),
			BorderColor3 = Color3.fromRGB(255,0,137),
			BorderMode = "Inset",
			BorderSizePixel = 1,
			Size = UDim2.new(1,0,1,0),
			Position = UDim2.new(0,0,0,0),
